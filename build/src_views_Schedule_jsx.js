"use strict";
(self["webpackChunkorb_products_services"] = self["webpackChunkorb_products_services"] || []).push([["src_views_Schedule_jsx"],{
...
/* harmony import */ var _controllers_servicesSlice__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../controllers/servicesSlice */ "./src/controllers/servicesSlice.js");
/* harmony import */ var _controllers_quoteSlice__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../controllers/quoteSlice */ "./src/controllers/quoteSlice.js");
/* harmony import */ var _controllers_invoiceSlice__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../controllers/invoiceSlice */ "./src/controllers/invoiceSlice.js");
...
/* harmony import */ var _utils_Schedule__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/Schedule */ "./src/utils/Schedule.js");
/* harmony import */ var _components_NavigationLogin__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/NavigationLogin */ "./src/views/components/NavigationLogin.jsx");
...
function ScheduleComponent() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (office_hours) {
      setOfficeHours((0,_utils_Schedule__WEBPACK_IMPORTED_MODULE_8__.formatOfficeHours)(office_hours));
    }
  }, [office_hours]);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (events) {
      setAvailableDates((0,_utils_Schedule__WEBPACK_IMPORTED_MODULE_8__.datesAvail)(events));
    }
  }, [events]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (selectedDate && dateSelectRef.current) {
      ...
      setAvailableTimes((0,_utils_Schedule__WEBPACK_IMPORTED_MODULE_8__.timesAvail)(events, key));
    }
  }, [selectedDate]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (availableTimes) {
  ...
  const handleDateChange = event => {
    if (dateSelectRef.current) {
      ...
      if (dateSelectRef.current.value !== undefined) {
        const key = dateSelectRef.current.value;
        (0,_utils_Schedule__WEBPACK_IMPORTED_MODULE_8__.timesAvail)(events, key);
      } else {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (selectedTime) {
      dispatch((0,_controllers_servicesSlice__WEBPACK_IMPORTED_MODULE_4__.getAvailableServices)());
    }
  }, [selectedTime, dispatch]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (availableServices && availableServices.length > 0) {
      setSelectedSummary(availableServices[0].description);
      dispatch((0,_controllers_scheduleSlice_js__WEBPACK_IMPORTED_MODULE_3__.updateSummary)(availableServices[0].description));
    }
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (summary && stripe_customer_id) {
      dispatch((0,_controllers_receiptSlice__WEBPACK_IMPORTED_MODULE_7__.getClientReceipts)()).then(() => {
        dispatch((0,_controllers_invoiceSlice__WEBPACK_IMPORTED_MODULE_6__.getClientInvoices)());
      }).then(() => {
        dispatch((0,_controllers_quoteSlice__WEBPACK_IMPORTED_MODULE_5__.getClientQuotes)());
      });
    }
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, officeHours && officeHours.length > 0 ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    key: index,
    value: time
  }, time)))) : '')), availableServices && availableServices.length > 0 ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "summary-select card"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    htmlFor: "summary"
  }, "About"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("select", {
    type: "text",
    name: "summary",
    id: "summary_select",
  ...
  }, availableServices.map((service, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    key: index,
    value: service.description
  }, service.description)))) : '', receipts && receipts.length > 0 || invoices && invoices.length > 0 || quotes && quotes.length > 0 ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "description-select card"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    htmlFor: "description"
  }, "Details"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("select", {
    type: "text",
    name: "description",
  ...
  }, receipts.map((receipt, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    key: index,
    value: `Receipt#${receipt.id}`
  }, "Receipt#", receipt.id)), invoices.map((invoice, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    key: index,
    value: `Invoice#${invoice.id}`
  }, "Invoice#", invoice.id)), quotes.map((quote, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    key: index,
    value: `Quote#${quote.id}`
  }, "Quote#", quote.id)))) : '', communication_preferences && communication_preferences.length > 0 ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onClick: handleClick
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "SCHEDULE")) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_NavigationLogin__WEBPACK_IMPORTED_MODULE_9__["default"], null));
}
