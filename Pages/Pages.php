...
class Pages
{
    ...
    public function react_rewrite_rules()
    {
        ...
        if ($services_page_id && $start_page_id && $selections_page_id && $quote_page_id && $invoice_page_id && $payment_page_id && $receipt_page_id && $schedule_page_id && $contact_page_id && $support_page_id) {
